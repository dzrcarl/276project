...
class ThingsControllerTest < ActionController::TestCase
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post :create, thing: { dexcription: @thing.dexcription, person_id: @thing.person_id, tname: @thing.tname }
    end
  ...
  test "should update thing" do
    patch :update, id: @thing, thing: { dexcription: @thing.dexcription, person_id: @thing.person_id, tname: @thing.tname }
    assert_redirected_to thing_path(assigns(:thing))
  end
